    ...
    slides: z
      .array(
        z.object({
          ...
          /**
           * Выноски: кривые линии от подписи к элементу экрана,
           * экспортированные из макета как SVG. Система координат та же,
           * что у выделений и подписей, а числа — рамка самой картинки:
           * рамка узла плюс вынос обводки экспорта. Вынос приходится
           * закладывать в контент, потому что у каждого файла он свой —
           * штрих выступает только с тех сторон, где кончается линия
           * (0, 0.5 или 2.887px).
           */
          connectors: z
            .array(
